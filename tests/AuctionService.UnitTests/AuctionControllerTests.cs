...
public class AuctionControllerTests
{
    ...
    [Fact]
    public async void GetAllAuctions_WithNoParams_Returns10Auctions()
    {
        // Arrange
        ...
        // Act
        var result = await _controller.GetAllAuctions(null, CancellationToken.None);
    ...
    public async void GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        // Action
        var result = await _controller.GetAuctionById(auction.Id, CancellationToken.None);
    ...
    [Fact]
    public async void GetAuctionById_WithInValidGuid_ReturnsNotFound()
    {
        // Arrange
        var auction = _fixture.Create<AuctionDto>();
    ...
    [Fact]
    public async void CreateAuction_WithValidAuctionDto_ReturnsCreatedAtAction()
    {
        // Arrange
        ...
        // Action
        var result = await _controller.CreateAuction(auction, CancellationToken.None);
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        // Act
        var result = await _controller.UpdateAuction(auction.Id, updateDto, CancellationToken.None);
    ...
    public async Task DeleteAuction_WithValidUser_ReturnsOkResponse()
    {
        ...
        // Act
        var result = await _controller.DeleteAuction(auction.Id, CancellationToken.None);
