...
public class DbInitializer
{
    ...
    {
        // Allow to dispose when the process is completed
    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        {
            Console.WriteLine("Already have data - Seeding is no need");
            return;
        }

        List<Auction> auctionList = new()
        {
            // 1 Ford GT
            new Auction
            {
