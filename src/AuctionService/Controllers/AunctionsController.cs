...
public class AuctionsController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<List<AuctionDto>>> GetAllAuctions(string date, CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<AuctionDto>> CreateAuction(CreateAuctionDto auctionDto, CancellationToken cancellationToken)
    {
        ...
        // Publishing message
        await _publishEndpoint.Publish(_mapper.Map<AuctionCreated>(newAuction), cancellationToken);
    ...
    public async Task<ActionResult> UpdateAuction(Guid id, UpdateAuctionDto updateAuctionDto, CancellationToken cancellationToken)
    {
        ...
        await _publishEndpoint.Publish(_mapper.Map<AuctionUpdated>(auction), cancellationToken);
    ...
    public async Task<ActionResult> DeleteAuction(Guid id, CancellationToken cancellationToken)
    {
        ...
        await _publishEndpoint.Publish<AuctionDeleted>(new { Id = auction.Id.ToString() }, cancellationToken);
